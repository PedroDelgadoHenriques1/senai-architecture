...
from .views import login_view, cadastro_produto_view, listar_produtos_view, cadastrar_fabricante_view, listar_fabricantes_view, cadastrar_grupo, listar_grupos, cadastrar_subgrupo, listar_subgrupos
